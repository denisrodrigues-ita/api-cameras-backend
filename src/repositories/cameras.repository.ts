...
export const getCameraByUUID = async (id: UUID): Promise<Prisma.CameraCreateInput | null> => {
  try {
...
export const toggleCamera = async (id: UUID, newState: boolean): Promise<Prisma.CameraUpdateInput> => {
  try {
